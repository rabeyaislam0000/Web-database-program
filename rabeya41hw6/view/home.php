...
<div class="row" style="height:400px">
   <div class="col-sm-4" style="background-color:gray ;">
     ...
     <img src="../image/dress.jpg" height="100%" width="100%">
   </div>
    <div  class="col-sm-8" style="background-color: olive ; ">
  <img src="../image/dress1.jpg" height="300px" width="230px">
  <img src="../image/dress2.jpg" height="300px" width="230px">
  <img src="../image/dress3.jpg" height="300px" width="230px">
  <p><b>“Fashion is part of the daily air and it changes all the time, with all the events. You can even see the approaching of a revolution in clothes. You can see and feel everything in clothes.”</b></p>
    </div>      
</div>
</div>
<div class="row">
